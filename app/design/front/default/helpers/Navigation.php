 ...
 * @subpackage  Ecart_Account_Helper
 * @author      Ecart Core Team <core@ecartcommerce.com>
 */
class Ecart_View_Helper_Navigation
{
    ...
    public function navigation(array $items)
    {
        ...
        if (!is_array($this->_activeCategories)) {
            ...
            if (Zend_Registry::isRegistered('catalog/current_category')) {
                $this->_activeCategories = array_keys(Ecart::single('catalog/category')->getParentItems(Zend_Registry::get('catalog/current_category')));
            }
        }
