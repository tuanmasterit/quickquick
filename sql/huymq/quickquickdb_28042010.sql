...
--
-- Host: localhost
-- Generation Time: Apr 28, 2010 at 04:11 PM
...
CREATE TABLE IF NOT EXISTS `definition_list_group` (
  ...
  `criteria_id` bigint(30) unsigned NOT NULL,
  `group_path` varchar(101) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `definition_relation_account_level` (
  ...
  KEY `fk_level_account_table` (`table_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
ALTER TABLE `definition_relation_account_level`
  ADD CONSTRAINT `fk_level_account` FOREIGN KEY (`account_id`) REFERENCES `definition_list_account` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `fk_level_account_table` FOREIGN KEY (`table_id`) REFERENCES `definition_list_table` (`table_id`) ON DELETE CASCADE ON UPDATE CASCADE;
