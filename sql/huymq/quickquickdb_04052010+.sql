...
--
-- Host: localhost
-- Generation Time: May 04, 2010 at 05:28 PM
...
CREATE TABLE IF NOT EXISTS `accountant_detail_correspondence` (
  ...
  PRIMARY KEY (`correspondence_id`,`table_id`,`detail_id`),
...
CREATE TABLE IF NOT EXISTS `accountant_detail_entry` (
  ...
  `table_id` bigint(30) unsigned NOT NULL,
  `detail_id` bigint(30) unsigned NOT NULL,
  PRIMARY KEY (`entry_id`,`table_id`,`detail_id`),
...
CREATE TABLE IF NOT EXISTS `accountant_transaction_batch` (
  ...
  `batch_note` varchar(100) NOT NULL,
...
(1, '', 'Hệ thống tài khoản kế toán', NULL, '', 1, 0, '1900-01-01 00:00:00', 0, '1900-01-01 00:00:00'),
