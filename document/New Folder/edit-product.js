    ...
    var gridDetailUnit = new Ext.grid.EditorGridPanel({
        ...
        listeners: {
            afteredit: function(e){
				...
				if (e.value <= 0){
					if (e.field == 'coefficient') e.value = 1;
					else e.value = 0;
				}
                ...
                Ext.Ajax.request({
                    ...
                    success: function(result, options){
						switch(e.field){
							case 'coefficient': e.record.data.coefficient = e.value; break;
							case 'default_sales_price': e.record.data.default_sales_price = e.value; break;
							case 'default_purchasing_price': e.record.data.default_purchasing_price = e.value; break;
							case 'default_inventory_price': e.record.data.default_inventory_price = e.value; break;
						}
                        e.record.commit();
                    },
